...
9. Click on "For read Configure Scoped Storage" at the bottom.
10. Click on "Step 1: Request Access:
11. You will be promptedwith a Files and folder gioalogue.
12. Navigate to the folder where you saved The Ocular Migrain apk file, usually in your Download folder.
...
15. Insatead, click on the dark circle in the upper right hand corner of the file that has the 4 arrows going in 4 different directions.
...
21. After it is finished you cna click on OPEN
22. Close ALL OTHER 2D WINDOWS, such as the FILES window as the message tell you do.
23. Then click on it to continue.
...
27. Then scroll down to WIRELESS DEBUGGIN and click on the WORDS WIRELESS DEBUGGIN to open the Wireless Debugging menu.
28. Click on the toggle switch in the upper right hand area of the Wireless Debuggin screen, if it's already on, toggle it off, then back on.
29. You will be prompted to "Allow wireless debugging on this network?"
30. Click on ALWAYS ALLOW ON THEI NETWORK (at the bottom of the prompt)
31. In the wireless debugging menu, click on PAIR DEVICE WITH PAIRGIN CODE.
32. A prompt will appear that says "PAIR WITH DEVICE.
33. It will show you a WiFi PAIRING CODE and an IP ADDRESS and PORT number.
34. Click on START PAIRING on the Installation Instruction screen on the right.
35. Enter in the Pairing code and click OK.
36. Enter in the PORT and click OK.
37. If it fails just toggle the USE WIRELESS DEBUGGIN switch off nad on a couple of times then try the pairing method again.
38. When successful you will be prompted to allow to connect ti adb debugging click on ALWAYS ALLOW ON THIS NETWORK.
39. The program will now close.
40. Go to UNKNOWN SOURCES and click on THE OCULAR MIGRAINE.
41. The Ocular Migraine will now open.
42. Enjoy using THe Ocular Migraine!
43. 
44. 
